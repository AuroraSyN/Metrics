...
public interface ICalculator {
	...
	/**
	 * 
	 * @return name of this calculator
	 */
	String getName();
	
	/**
	 * Sets the name of this calculator
	 * @param name name for this calculator
	 */
	void setName(String name);
	
	/**
	 * invoke the calculation
	 * @param source source of code and other metrics if required
	 */
